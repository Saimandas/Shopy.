...
const ProductDisplay = () => {
  return (
    <>
      <div className="antialiased mt-[-3%]">
        <div className="py-6">
            ...
            <div className="flex flex-col md:flex-row -mx-4">
                  ...
                  <div className="flex -mx-2 mb-4">
                    <template x-for="i in 4">
                      <div className="flex-1 px-2">
                        <button x-on:click="image = i" class="{ 'ring-2 ring-indigo-300 ring-inset': image === i }" className="focus:outline-none w-full rounded-lg h-24 md:h-32 bg-gray-100 flex items-center justify-center">
              ...
              <div className="md:flex-1 px-4">
                ...
                <div className="flex py-4 space-x-4">
                  ...
                  <button type="button" className="h-14 px-6 py-2 font-semibold rounded-xl bg-orange-600 hover:bg-orange-500 text-white">Buy Now </button>
                </div>
              </div>
            </div>
          </div>
